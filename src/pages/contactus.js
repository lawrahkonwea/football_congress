      ...
      <div className='px-4 pt-[150px]'>
        ...
        <div className='flex flex-wrap justify-between text-center md:flex-row flex-col px-8'>
          ...
          <div className='p-4'>
            ...
            <p className="px-8">africafootballempowermentcongr@gmail.com</p>
          </div>
        ...
        <div className='items-center'>
          <div className='text-center'>
            <div className='inline-block'>
              <img className='bg-zinc-400 w-[200px] h-[200px] rounded-lg mt-4 mb-2' src={Fifa} alt='members' />
          ...
          <div className='flex flex-wrap justify-around gap-8 px-8 mt-6'>
            <div className='items-center justify-center'>
              <img className=' w-[200px] h-[200px] rounded-lg mb-2' src={President} alt='members' />
              <h3 className='font-semibold'>DR. Samuel V.O Johnson</h3>
              <p>AFEC President</p>
            </div>

            <div className='items-center justify-center' >
              <img className=' w-[200px] h-[200px]  rounded-lg mb-2' src={Vice} alt='members' />
              <h3 className='font-semibold'>DR. Diana Ajaine Asak-Johnson</h3>
              <p>AFEC Vice-President</p>
            </div>

            <div className=' items-center justify-center'>
              <img className=' w-[200px] h-[200px] rounded-lg mb-2' src={Developer} alt='members' />
          ...
          <div className='flex flex-wrap justify-center gap-12 px-8'>
            <div className='items-center justify-center'>
              <img className='bg-zinc-400  w-[200px] h-[200px] rounded-lg mb-2' src={Randy} alt='members' />
              <h3 className='font-semibold'>Randy Moore</h3>
              <p>Agent/Partner</p>
            </div>

            <div className='bg-custom-bg items-center justify-center'>
              <img className='w-[200px] h-[200px] rounded-lg mb-2' src={Howard} alt='members' />
